...
There are for types reactions of Bossman can have for shown events:
	a) win [currently 2 different clips],
	b) loss [currently 3 different clips],
	c) beg [currently 2 different clips],
	d) rage [currently 3 different clips].

As for today, there are implemented following games:
	1) YesNoGame - it is basically a coin flip, but with 25 % chance of winning, based on this reddit post:
		       https://www.reddit.com/r/bossmanjack/comments/1bqfwqo/new_game_made_just_for_the_boss/

Project is in early Alpha version, it might be continued in the future (however cannot promise anything).
